...
export default function Hero() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-a2-bg">
      ...
      {/* Content (z-10) */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-20 min-h-[86vh] flex items-center justify-center">
        <div className="w-full max-w-4xl text-center min-w-0">
          ...
          {/* Search bar */}
          <form onSubmit={submit} className="mt-8 w-full max-w-2xl mx-auto">
